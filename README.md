...
Tenho experiência com desenvolvimento de aplicações móveis e web. _Cheguei a desenvolver API's com NodeJS e Django, mas nada surpreendente_. Mas as **principais tecnologias** que domino são **TypeScript/JavaScript**, **React**, **Expo**, **Tailwind**, **Styled Components** e **Leaflet**.
